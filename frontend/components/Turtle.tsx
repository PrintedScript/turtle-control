			...
			<div className={classes.toolbar} style={{ display: enabled ? undefined : "none" }}>
				...
				<div className={classes.groups}>
					<ColoredButtonGroup groupColor='#e74c3c' size="small" orientation="vertical">
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.dig(BlockDirection.UP)}><ArrowUpward /></Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.dig(BlockDirection.FORWARD)}>
							dig
						</Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.dig(BlockDirection.DOWN)}><ArrowDownward /></Button>
					</ColoredButtonGroup>
					...
					<ColoredButtonGroup groupColor='#f1c40f' size="small" orientation="vertical">
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.suck(BlockDirection.UP)}><ArrowUpward /></Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.suck(BlockDirection.FORWARD)}>
							suck
						</Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.suck(BlockDirection.DOWN)}><ArrowDownward /></Button>
					</ColoredButtonGroup>
					<ColoredButtonGroup groupColor='#f1c40f' size="small" orientation="vertical">
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.drop(BlockDirection.UP)}><ArrowUpward /></Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.drop(BlockDirection.FORWARD)}>
							drop
						</Button>
						<Button tabIndex="-1" variant="outlined" color="primary" onClick={() => turtle.drop(BlockDirection.DOWN)}><ArrowDownward /></Button>
					</ColoredButtonGroup>
					...
					<div>
					<Typography variant="subtitle2" style={{"color": "rgb(200,200,200)"}}>X: {turtle.x} Y: {turtle.y} Z: {turtle.z}</Typography>
						<TextField
							label="Mine Tunnel"
							variant="outlined"
							value={mineLength}
